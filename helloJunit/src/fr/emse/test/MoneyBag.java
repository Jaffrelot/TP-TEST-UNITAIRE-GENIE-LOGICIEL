	...
	m.amount(),m.currency()));
	 ...
	 @Override
	    public boolean equals(Object obj) {
	        ...
	        // Vérifie si les deux sacs d'argent contiennent le même nombre d'objets Money
	        if (fMonies.size() != other.fMonies.size())
	            return false;
	        // Vérifie si tous les objets Money dans les deux sacs d'argent sont égaux deux à deux
